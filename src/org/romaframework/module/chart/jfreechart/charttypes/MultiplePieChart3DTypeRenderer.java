 ...
 *
 */
public class MultiplePieChart3DTypeRenderer implements ChartTypeRenderer{


	public void render(Dataset dataset, RenderOptions options, OutputStream outputStream) {
		JFreeChart chart = ChartFactory.createMultiplePieChart3D(options.getChartTitle(), (CategoryDataset) dataset, TableOrder.BY_ROW, options.isShowLegend(), false, false);
