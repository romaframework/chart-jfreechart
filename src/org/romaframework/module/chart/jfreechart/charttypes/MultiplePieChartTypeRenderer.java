...
/**
 * provides the logic to represent a dataset as a pie chart
...
public class MultiplePieChartTypeRenderer implements ChartTypeRenderer{
	...
	public void render(Dataset dataset, RenderOptions options, OutputStream outputStream) {
		JFreeChart chart = ChartFactory.createMultiplePieChart(options.getChartTitle(), (CategoryDataset) dataset, TableOrder.BY_ROW, options.isShowLegend(), false, false);
