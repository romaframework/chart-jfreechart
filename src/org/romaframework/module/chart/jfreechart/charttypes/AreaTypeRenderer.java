 ...
 *
 */
public class AreaTypeRenderer implements ChartTypeRenderer{


	public void render(Dataset dataset, RenderOptions options, OutputStream outputStream) {
		JFreeChart chart = ChartFactory.createAreaChart(options.getChartTitle(), options.getXLabel(), options.getYLabel(), (CategoryDataset) dataset, options.getOrientation(), options.isShowLegend(), false, false);
