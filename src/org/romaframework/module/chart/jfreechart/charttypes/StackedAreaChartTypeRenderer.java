 ...
 * 
 */
public class StackedAreaChartTypeRenderer implements ChartTypeRenderer {

	public void render(Dataset dataset, RenderOptions options, OutputStream outputStream) {
		JFreeChart chart = ChartFactory.createStackedAreaChart(options.getChartTitle(), options.getXLabel(), options.getYLabel(),
