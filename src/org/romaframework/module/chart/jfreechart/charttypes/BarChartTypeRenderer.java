...
/**
 * provides the logic to represent a dataset as a bar chart
 * 
 * @author Luigi Dell'Aquila
 * 
 */
public class BarChartTypeRenderer implements ChartTypeRenderer {

	public void render(Dataset dataset, RenderOptions options, OutputStream outputStream) {
		JFreeChart chart = ChartFactory.createBarChart(options.getChartTitle(), options.getXLabel(), options.getYLabel(),
				(CategoryDataset) dataset, options.getOrientation(), options.isShowLegend(), options.isShowTooltip(), false);
