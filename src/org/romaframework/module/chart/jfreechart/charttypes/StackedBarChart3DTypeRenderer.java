...
/**
 * provides the logic to represent a dataset as a 3D stacked bar chart
 * 
 * @author Luigi Dell'Aquila
 * 
 */
public class StackedBarChart3DTypeRenderer implements ChartTypeRenderer {

	public void render(Dataset dataset, RenderOptions options, OutputStream outputStream) {
		JFreeChart chart = ChartFactory.createStackedBarChart3D(options.getChartTitle(), options.getXLabel(), options.getYLabel(),
				(CategoryDataset) dataset, options.getOrientation(), options.isShowLegend(), false, false);
