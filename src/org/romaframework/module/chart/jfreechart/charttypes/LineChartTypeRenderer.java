...
/**
 * provides the logic to represent a dataset as a line chart
 * @author Luigi Dell'Aquila
 *
 */
public class LineChartTypeRenderer  implements ChartTypeRenderer{


	public void render(Dataset dataset, RenderOptions options, OutputStream outputStream) {
		JFreeChart chart = ChartFactory.createLineChart(options.getChartTitle(), options.getXLabel(), options.getYLabel(), (CategoryDataset) dataset, options.getOrientation(), options.isShowLegend(), false, false);
