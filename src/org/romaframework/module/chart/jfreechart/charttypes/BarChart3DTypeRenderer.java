 ...
 * 
 */
public class BarChart3DTypeRenderer implements ChartTypeRenderer {

	public void render(Dataset dataset, RenderOptions options, OutputStream outputStream) {
		JFreeChart chart = ChartFactory.createBarChart3D(options.getChartTitle(), options.getXLabel(), options.getYLabel(),
